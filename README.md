...
• แนวโน้มของ PM2.5 มีลักษณะเป็นช่วง ๆ มีค่าสูงในช่วงฤดูหนาว-ต้นปี (ม.ค.-มี.ค.) และลดลงช่วงกลางปี มีลักษณะเป็นวัฏจักรซ้ำ ๆ ทุกปี โมเดล Linear Regression สามารถจับแนวโน้มได้ดี

• เส้น Predicted PM2.5 (เส้นประสีแดง) ค่อนข้างตรงกับ Actual PM2.5 (เส้นสีน้ำเงิน) แสดงให้เห็นว่า Linear Regression จับรูปแบบของข้อมูลได้ดี 

• ความผิดพลาดอาจเกิดขึ้นในค่าที่ผันผวนสูง บางจุดที่ค่า PM2.5 สูงมาก (เช่นช่วง peak) โมเดลอาจพยากรณ์ต่ำกว่าค่าจริง 

• อาจเกิดจากข้อจำกัดของ Linear Regression ที่ไม่สามารถจับความไม่เป็นเชิงเส้น (non-linearity) ได้ดี
